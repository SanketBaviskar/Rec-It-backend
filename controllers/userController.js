...
const addUser = async (req, res) => {
  try {
    ...
    sendSuccessResponse(res, HTTP_STATUS.CREATED, user, SUCCESS_MESSAGES.REGISTERED_SUCCESS);
  } catch (error) {
    console.log(error);
...
const register = async (req, res) => {
  try {
    ...
    sendSuccessResponse(res, HTTP_STATUS.CREATED, { userId: user.id }, SUCCESS_MESSAGES.REGISTERED_SUCCESS);
  } catch (error) {
    sendErrorResponse(res, HTTP_STATUS.BAD_REQUEST, ERROR_MESSAGES.REGISTER_ERROR);
  }
};
